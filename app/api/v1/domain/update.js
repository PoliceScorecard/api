        ...
        .on('data', async row => {
          ...
          const cleanData = {
            ...
            arrests: {
              ...
              black_low_level_arrest_rate: util.parseInt(row.black_low_level_arrest_rate, false, true),
              black_low_level_arrests: util.parseInt(row.black_low_level_arrests, false, true),
              black_white_low_level_arrest_disparity: util.parseInt(row.black_white_low_level_arrest_disparity, false, true),
              hispanic_low_level_arrest_rate: util.parseInt(row.hispanic_low_level_arrest_rate, false, true),
              hispanic_low_level_arrests: util.parseInt(row.hispanic_low_level_arrests, false, true),
              hispanic_white_low_level_arrest_disparity: util.parseInt(row.hispanic_white_low_level_arrest_disparity, false, true),
              white_low_level_arrest_rate: util.parseInt(row.white_low_level_arrest_rate, false, true),
