...
const SCORECARD_COLUMNS = [
  ...
  'carotid_restraints_2024',
  'carotid_restraints_2025',
  'chemical_spray_2024',
  'chemical_spray_2025',
  'K9_deployments_2024',
  'K9_deployments_2025',
...
const __getRowValue = (row, column, alias) => {
  ...
  if (alias && typeof row[alias] !== 'undefined') {
    return row[alias]
  }
...
const __calcLessLethalForceChange = (row) => {
  ...
  const lessLethalForce2024 = util.parseInt(row.less_lethal_force_2024, false) || null
  const lessLethalForce2025 = util.parseInt(row.less_lethal_force_2025, false) || null
  ...
  } else if (!start && lessLethalForce2024) {
    start = lessLethalForce2024
  } else if (!start && lessLethalForce2025) {
    start = lessLethalForce2025
  }
  ...
  if (lessLethalForce2024) {
    end = lessLethalForce2024
  }
  if (lessLethalForce2025) {
    end = lessLethalForce2025
  }
...
const __calcPoliceShootingsIncidents = (row) => {
  ...
  const policeShootings2024 = util.parseInt(row.police_shootings_2024, true) || 0
  const policeShootings2025 = util.parseInt(row.police_shootings_2025, true) || 0
...
module.exports = {
  ...
  /**
   * Confirm Scorecard CSV File is ready for import
   */
  downloadScorecard () {
    return new Promise((resolve, reject) => {
      // Check that Scorecard File Exists
      if (!fs.existsSync(SCORECARD_PATH)) {
        return reject(`File does not exist: ${SCORECARD_PATH}`)
      }

      try {
        // Check that file has Read Access
        fs.accessSync(SCORECARD_PATH, fs.constants.R_OK)
      } catch (err) {
        return reject(`File does not have Read Access: ${SCORECARD_PATH}`)
      }
  ...
  async importScorecard (rowCount, cleanImport) {
    return new Promise((resolve, reject) => {
      ...
      const checkComplete = () => {
        if (!parserEnded || activeRows > 0) {
          return
        }

        if (processed !== expectedRows) {
          return settle(reject, `Processed ${processed} rows, expected ${expectedRows}`)
        }
      ...
      const parser = scorecard.on('error', failImport).pipe(
        csv({
          columns: true,
          trim: true,
      ...
      // Loop through each row of CSV. Pause the parser so each row's database writes finish before the next row starts.
      parser
        .on('data', row => {
          activeRows += 1
          parser.pause()
          ...
          // Check if we are not doing a Clean Import, and skip rows that are `current`
            ...
            if (row.police_budget_2024 && row.police_budget_2024.length > 0 && row.corrections_budget_2024 && row.corrections_budget_2024.length > 0 && row.total_budget_2024 && row.total_budget_2024.length > 0) {
              row.corrections_budget = row.corrections_budget_2024
            }
            if (row.police_budget_2025 && row.police_budget_2025.length > 0 && row.corrections_budget_2025 && row.corrections_budget_2025.length > 0 && row.total_budget_2025 && row.total_budget_2025.length > 0) {
              row.corrections_budget = row.corrections_budget_2025
            }
            ...
            if (row.police_budget_2024 && row.police_budget_2024.length > 0 && row.health_budget_2024 && row.health_budget_2024.length > 0 && row.total_budget_2024 && row.total_budget_2024.length > 0) {
              row.health_budget = row.health_budget_2024
            }
            if (row.police_budget_2025 && row.police_budget_2025.length > 0 && row.health_budget_2025 && row.health_budget_2025.length > 0 && row.total_budget_2025 && row.total_budget_2025.length > 0) {
              row.health_budget = row.health_budget_2025
            }
            ...
            if (row.police_budget_2024 && row.police_budget_2024.length > 0 && row.housing_budget_2024 && row.housing_budget_2024.length > 0 && row.total_budget_2024 && row.total_budget_2024.length > 0) {
              row.housing_budget = row.housing_budget_2024
            }
            if (row.police_budget_2025 && row.police_budget_2025.length > 0 && row.housing_budget_2025 && row.housing_budget_2025.length > 0 && row.total_budget_2025 && row.total_budget_2025.length > 0) {
              row.housing_budget = row.housing_budget_2025
            }
            ...
            if (row.police_budget_2024 && row.police_budget_2024.length > 0 && row.total_budget_2024 && row.total_budget_2024.length > 0) {
              row.police_budget = row.police_budget_2024
              row.total_budget = row.total_budget_2024
            }
            if (row.police_budget_2025 && row.police_budget_2025.length > 0 && row.total_budget_2025 && row.total_budget_2025.length > 0) {
              row.police_budget = row.police_budget_2025
              row.total_budget = row.total_budget_2025
            }
            ...
            const importStateData = (row, result, cleanData) => {
            // Add
              cleanData.agency.country_id = result.country_id
            ...
            const cleanData = {
              ...
              police_accountability: {
                ...
                civilian_complaints_reported_2024: util.parseInt(row.civilian_complaints_reported_2024, false, true),
                civilian_complaints_reported_2025: util.parseInt(row.civilian_complaints_reported_2025, false, true),
                ...
                civilian_complaints_sustained_2024: util.parseInt(row.civilian_complaints_sustained_2024, false, true),
                civilian_complaints_sustained_2025: util.parseInt(row.civilian_complaints_sustained_2025, false, true),
                ...
                complaints_in_detention_reported_2024: util.parseInt(row.complaints_in_detention_reported_2024, false, true),
                complaints_in_detention_reported_2025: util.parseInt(row.complaints_in_detention_reported_2025, false, true),
                ...
                complaints_in_detention_sustained_2024: util.parseInt(row.complaints_in_detention_sustained_2024, false, true),
                complaints_in_detention_sustained_2025: util.parseInt(row.complaints_in_detention_sustained_2025, false, true),
                ...
                criminal_complaints_reported_2024: util.parseInt(row.criminal_complaints_reported_2024, false, true),
                criminal_complaints_reported_2025: util.parseInt(row.criminal_complaints_reported_2025, false, true),
                ...
                criminal_complaints_sustained_2024: util.parseInt(row.criminal_complaints_sustained_2024, false, true),
                criminal_complaints_sustained_2025: util.parseInt(row.criminal_complaints_sustained_2025, false, true),
                ...
                discrimination_complaints_reported_2024: util.parseInt(row.discrimination_complaints_reported_2024, false, true),
                discrimination_complaints_reported_2025: util.parseInt(row.discrimination_complaints_reported_2025, false, true),
                ...
                discrimination_complaints_sustained_2024: util.parseInt(row.discrimination_complaints_sustained_2024, false, true),
                discrimination_complaints_sustained_2025: util.parseInt(row.discrimination_complaints_sustained_2025, false, true),
                ...
                use_of_force_complaints_reported_2024: util.parseInt(row.use_of_force_complaints_reported_2024, false, true),
                use_of_force_complaints_reported_2025: util.parseInt(row.use_of_force_complaints_reported_2025, false, true),
                ...
                use_of_force_complaints_sustained_2024: util.parseInt(row.use_of_force_complaints_sustained_2024, false, true),
                use_of_force_complaints_sustained_2025: util.parseInt(row.use_of_force_complaints_sustained_2025, false, true),
              ...
              police_funding: {
                ...
                corrections_budget_2024: util.parseInt(row.corrections_budget_2024, false, true),
                corrections_budget_2025: util.parseInt(row.corrections_budget_2025, false, true),
                ...
                fines_forfeitures_2024: util.parseInt(row.fines_forfeitures_2024, false, true),
                fines_forfeitures_2025: util.parseInt(row.fines_forfeitures_2025, false, true),
                ...
                health_budget_2024: util.parseInt(row.health_budget_2024, false, true),
                health_budget_2025: util.parseInt(row.health_budget_2025, false, true),
                ...
                housing_budget_2024: util.parseInt(row.housing_budget_2024, false, true),
                housing_budget_2025: util.parseInt(row.housing_budget_2025, false, true),
                ...
                police_budget_2024: util.parseInt(row.police_budget_2024, false, true),
                police_budget_2025: util.parseInt(row.police_budget_2025, false, true),
                ...
                total_budget_2024: util.parseInt(row.total_budget_2024, false, true),
                total_budget_2025: util.parseInt(row.total_budget_2025, false, true),
                ...
                total_officers_2024: util.parseInt(row.total_officers_2024, false, true),
                total_officers_2025: util.parseInt(row.total_officers_2025, false, true),
              ...
              police_violence: {
                ...
                less_lethal_force_2024: util.parseInt(row.less_lethal_force_2024, false, true),
                less_lethal_force_2025: util.parseInt(row.less_lethal_force_2025, false, true),
                ...
                police_shootings_2024: util.parseInt(row.police_shootings_2024, false, true),
                police_shootings_2025: util.parseInt(row.police_shootings_2025, false, true),
                ...
                taser_2013: util.parseInt(row.taser_2013, false, true),
                taser_2014: util.parseInt(row.taser_2014, false, true),
                taser_2015: util.parseInt(row.taser_2015, false, true),
                taser_2016: util.parseInt(row.taser_2016, false, true),
                taser_2017: util.parseInt(row.taser_2017, false, true),
                taser_2018: util.parseInt(row.taser_2018, false, true),
                ...
                taser_2024: util.parseInt(row.taser_2024, false, true),
                taser_2025: util.parseInt(row.taser_2025, false, true),
                ...
                impact_weapons_and_projectiles_2016: util.parseInt(row.impact_weapons_and_projectiles_2016, false, true),
                impact_weapons_and_projectiles_2017: util.parseInt(row.impact_weapons_and_projectiles_2017, false, true),
                impact_weapons_and_projectiles_2018: util.parseInt(row.impact_weapons_and_projectiles_2018, false, true),
                ...
                impact_weapons_and_projectiles_2024: util.parseInt(row.impact_weapons_and_projectiles_2024, false, true),
                impact_weapons_and_projectiles_2025: util.parseInt(row.impact_weapons_and_projectiles_2025, false, true),
                ...
                neck_restraints_2016: util.parseInt(row.neck_restraints_2016, false, true),
                neck_restraints_2017: util.parseInt(row.neck_restraints_2017, false, true),
                neck_restraints_2018: util.parseInt(row.neck_restraints_2018, false, true),
                ...
                neck_restraints_2024: util.parseInt(__getRowValue(row, 'carotid_restraints_2024', 'neck_restraints_2024'), false, true),
                neck_restraints_2025: util.parseInt(__getRowValue(row, 'carotid_restraints_2025', 'neck_restraints_2025'), false, true),
                ...
                chemical_spray_2016: util.parseInt(row.chemical_spray_2016, false, true),
                chemical_spray_2017: util.parseInt(row.chemical_spray_2017, false, true),
                chemical_spray_2018: util.parseInt(row.chemical_spray_2018, false, true),
                ...
                chemical_spray_2024: util.parseInt(row.chemical_spray_2024, false, true),
                chemical_spray_2025: util.parseInt(row.chemical_spray_2025, false, true),
                ...
                K9_deployments_2016: util.parseInt(row.K9_deployments_2016, false, true),
                K9_deployments_2017: util.parseInt(row.K9_deployments_2017, false, true),
                ...
                K9_deployments_2024: util.parseInt(row.K9_deployments_2024, false, true),
                K9_deployments_2025: util.parseInt(row.K9_deployments_2025, false, true)
              },
              policy: {
            ...
            // Search Counties for Sheriff Department
              return models.geo_counties.findOne({
                ...
                if (result) {
                  return importSheriffData(row, result, cleanData)
                }

                return __upsertCounty(row).then((county) => {
                  return importSheriffData(row, county, cleanData)
                }).catch(() => {
                  return importWarning(row, row.agency_type)
                })
              }).catch((err) => {
                return importError(err, row)
              })
            ...
            // Search Counties for Police Department
              return models.geo_cities.findOne({
                ...
                if (result) {
                  return importPoliceData(row, result, cleanData)
                }

                return __upsertCity(row).then((city) => {
                  return importPoliceData(row, city, cleanData)
                }).catch(() => {
                  return importWarning(row, row.agency_type)
                })
              }).catch((err) => {
            ...
            // Search State
              return models.geo_states.findOne({
                where: {
                  fips_code: util.leftPad(row.fips_state_code, 2, '0')
                }
              }).then((result) => {
                if (result) {
                  return importStateData(row, result, cleanData)
                }
